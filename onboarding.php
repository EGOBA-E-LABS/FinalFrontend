          ...
          <div class="carousel-inner">
            <div class="carousel-item active" data-interval="3000">
              ...
              <div class="carousel-caption d-md-block">
                ...
                <p class="w-75 mx-auto my-0">Discover the best foods from over 1,000 restaruants.</p>
              </div>
            </div>
            <div class="carousel-item" data-interval="3000">
              ...
              <div class="carousel-caption d-md-block">
                <h5>Fast Delivery</h5>
                <p class="w-75 mx-auto my-0">Fast delivery to your home, office and wherever you are.</p>
              </div>
            </div>
            <div class="carousel-item" data-interval="3000">
              ...
              <div class="carousel-caption d-md-block">
                <h5>Live Tracking</h5>
                <p class="w-75 mx-auto my-0">Real time tracking of your food on the app after ordered.</p>
              </div>
            </div>
          </div>
        </div>
